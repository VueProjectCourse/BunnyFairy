  ...
  return [
    ...
    },
    {
      ...
      children: [
        ...
        { text: '结算-收货地址-渲染', link: "/settlement/address-render"},
        { text: '结算-收货地址-修改',link: "/settlement/address-modify" },
        { text: '结算-收货地址-切换', link: "/settlement/address-toggle"},
        { text: '结算-提交订单', link: "/settlement/order-submit"},
    ...
    },
    {
      ...
      children: [
        ...
        { text: '订单管理-条件查询', link: "/profile/condition-search"},
        { text: '订单管理-取消订单(1)', link: "/profile/order-cancel1"},
        { text: '订单管理-取消订单(2)', link: "/profile/order-cancel2"},
        { text: '订单管理-删除订单', link: "/profile/order-delete"},
        { text: '订单管理-确认收货', link: "/profile/order-confirm"},
        { text: '订单管理-查看物流', link: "/profile/order-express"},
        { text: '订单详情-头部展示', link: "/profile/order-header"},
